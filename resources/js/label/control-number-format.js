 ...
 */
 ...
 export default ( { numberFormat, setAttributes } ) => {
	 ...
	 const currencyControl = numberFormat?.style === 'currency' && (
		 <SelectControl
			 label={ __( 'Number Format: Currency', 'x3p0-progress' ) }
	 ...
	 const currencyDisplayControl = numberFormat?.style === 'currency' && (
		 <SelectControl
			 label={ __( 'Number Format: Currency Display', 'x3p0-progress' ) }
	 ...
	 const unitControl = numberFormat?.style === 'unit' && (
		 <SelectControl
			 label={ __( 'Number Format: Unit', 'x3p0-progress' ) }
	 ...
	 const unitDisplayControl = numberFormat?.style === 'unit' && (
		 <SelectControl
			 label={ __( 'Number Format: Unit Display', 'x3p0-progress' ) }
